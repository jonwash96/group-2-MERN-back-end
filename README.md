#  💰 $pendSense - Personal Expense Tracker (API)

![SpendTrack Logo](pic/logo.png)
##  
[Launch App](https://spend-sense-puce-eta.vercel.app/)
[View the front end repository](https://www.github.com/jonwash96/group-2-MERN-front-end)
...
**$pendSense** is designed to help users manage their personal finances with little to zero effort. Track your expenses, set budgets, manage recurring payments, visualize your spending habits all in an intutitive dashboard.
...
### 📊 Dashboard Overview
![Dashboard overview](pic/dashboard.png)
